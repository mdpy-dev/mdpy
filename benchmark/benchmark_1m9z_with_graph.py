"""mdpy 1M9Z (95,567 atoms) CUDA Graph performance benchmark.

Usage:
    conda run -n md_analysis python benchmark/benchmark_1m9z_with_graph.py

Measures per-step performance WITH CUDA Graph enabled.
No profiling overhead — measures pure graph replay cost.
...
def main():
    ...
    print("mdpy 1M9Z CUDA Graph benchmark")
    ...
    print(f"Warmup ({WARMUP_STEPS} steps, no profiling)...")
    ...
    print(f"  CUDA Graph active: {system._step_graph is not None}")
