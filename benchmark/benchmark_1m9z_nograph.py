"""mdpy 1M9Z benchmark — explicit pipeline, no CUDA Graph.

Every kernel appears individually in nsys timeline for kernel-level profiling.
"""
...
def main():
    ...
    print("mdpy 1M9Z benchmark (explicit pipeline)")
