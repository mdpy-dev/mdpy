...
class CharmmAngleConstraint(Constraint):
    ...
    def bind_ensemble(self, ensemble: Ensemble):
        ...
        self._block_per_grid = int(
            np.ceil(self._parent_ensemble.topology.num_angles / THREAD_PER_BLOCK)
        )
    ...
    def _update_charmm_angle_kernel(
        ...
        shared_num_angles = cuda.shared.array((1), NUMBA_INT)
        ...
        local_positions = cuda.local.array((3, SPATIAL_DIM), NUMBA_FLOAT)
        local_forces = cuda.local.array((3, SPATIAL_DIM), NUMBA_FLOAT)
        for i in range(3):
        ...
        # vec
        # r21
        v21 = cuda.local.array((SPATIAL_DIM), NUMBA_FLOAT)
        v23 = cuda.local.array((SPATIAL_DIM), NUMBA_FLOAT)
        v13 = cuda.local.array((SPATIAL_DIM), NUMBA_FLOAT)
        r21, r23, r13 = 0, 0, 0
        ...
        r23 = math.sqrt(r23)
        r13 = math.sqrt(r13)
        scaled_v21 = cuda.local.array((SPATIAL_DIM), NUMBA_FLOAT)
        scaled_v23 = cuda.local.array((SPATIAL_DIM), NUMBA_FLOAT)
        scaled_v13 = cuda.local.array((SPATIAL_DIM), NUMBA_FLOAT)
        ...
        vec_norm = cuda.local.array((SPATIAL_DIM), NUMBA_FLOAT)
        ...
        force_vec1 = cuda.local.array((SPATIAL_DIM), NUMBA_FLOAT)
        ...
        force_vec3 = cuda.local.array((SPATIAL_DIM), NUMBA_FLOAT)
