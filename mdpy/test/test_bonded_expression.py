...
class TestBondedTranspiler:
    ...
    def test_harmonic_bond_transpilation(self):
        ...
        assert harmonic_bond.param_names == ['k', 'r0']
    ...
    def test_periodic_dihedral_transpilation(self):
        ...
        assert 'k' in periodic_dihedral.param_names
        assert 'n' in periodic_dihedral.param_names
        assert 'delta' in periodic_dihedral.param_names
