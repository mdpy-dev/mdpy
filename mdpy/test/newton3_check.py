...
def get_pdb_forces(system):
    ...
    pdb_fx = state.permute_from_sorted(sorted_to_pdb, state.d_forces_x).get()
    pdb_fy = state.permute_from_sorted(sorted_to_pdb, state.d_forces_y).get()
    pdb_fz = state.permute_from_sorted(sorted_to_pdb, state.d_forces_z).get()
