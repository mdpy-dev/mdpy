...
class PDBParser:
        ...
        for line in lines:
            ...
            if record in ('ATOM', 'HETATM'):
                if first_atom_section:
                    ...
                    self._particle_residue_ids.append(int(line[22:26]))
                    self._particle_residue_names.append(line[17:21].strip())
    ...
    def get_particle_info(self, particle_id):
        ...
        return {
            ...
            'residue_id': self._particle_residue_ids[matrix_id],
            'residue_name': self._particle_residue_names[matrix_id],
